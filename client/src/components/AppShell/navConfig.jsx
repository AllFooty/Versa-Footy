...
const navConfig = [
  ...
  },
  {
    ...
    visible: ({ orgsLoading, organizations }) => !orgsLoading && organizations.length > 0,
    items: [
      { labelKey: 'nav.dashboard', href: '/academy', exact: true, icon: DashboardIcon },
  ...
  },
  {
    ...
    visible: () => true,
    items: [
      { labelKey: 'nav.account', href: '/settings', icon: SettingsIcon },
    ],
  },
];
