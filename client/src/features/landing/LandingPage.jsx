...
const howItWorksSteps = [
  {
    ...
    icon: '🎯',
    description: 'Tell us your age. We build a personalized roadmap—showing exactly which skills to master and when. Based on proven youth development science.',
    color: '#ff4b4b',
  },
  {
    step: 2,
    title: 'Train Daily',
    icon: '⚽',
    description: 'Sessions are tailored from 1000+ exercises. We prioritize what your kid needs: skills they\'ve neglected and techniques that matter for their age.',
    color: '#6366f1',
  },
  {
    step: 3,
    title: 'Rate & Track',
    icon: '📊',
    description: 'Rate each exercise. Our AI tracks progress, calculates mastery, and recommends what to focus on next.',
    color: '#22c55e',
  },
  {
    step: 4,
    title: 'Level Up',
    icon: '⭐',
    description: 'Every session earns XP. Better performance earns more. Daily streaks multiply rewards. Progress feels like a game—but the skills are real on the pitch.',
    color: '#ffd166',
  },
];
